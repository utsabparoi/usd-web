...
!function (a, b) {
    var c = function (b, c) {
        function d(a) {
            ...
            var b = A.offset(), c = b[o], d = u ? a.pageY : a.pageX;
        ...
        function k() {
            if (V !== !1) {
                var a = y.offset(), b = a.left, c = a.top;
        ...
        var l = this, m = ace.helper.getAttrSettings(b, a.fn.ace_scroll.defaults),
            n = a.extend({}, a.fn.ace_scroll.defaults, c, m);
        this.size = 0, this.lock = !1, this.lock_anyway = !1, this.$element = a(b), this.element = b;
        var o, p, q, r, s, t, u = !0, v = !1, w = !1, x = !1, y = null, z = null, A = null, B = null, C = null,
            D = null, E = null, F = 0, G = 0, H = 0, I = 0, J = !0, K = !1, L = "", M = !1, N = 0, O = 1, P = !1,
            Q = !1, R = "onmouseup" in window ? window : "html", S = n.dragEvent || !1, T = c.scrollEvent || !1,
            U = n.detached || !1, V = n.updatePos || !1, W = n.hideOnIdle || !1, X = n.hideDelay || 1500, Y = !1,
            Z = n.observeContent || !1, $ = 0, _ = !0;
        this.ref = function () {
            return this
    ...
    a.fn.ace_scroll = function (d, e) {
        var f, g = this.each(function () {
            var b = a(this), g = b.data("ace_scroll"), h = "object" == typeof d && d;
    ...
    var c = function (b, c) {
        var d = ace.helper.getAttrSettings(b, a.fn.ace_colorpicker.defaults),
            e = a.extend({}, a.fn.ace_colorpicker.defaults, c, d), f = a(b), g = "", h = "", i = null, j = [];
        f.addClass("hide").find("option").each(function () {
            var a = "colorpick-btn", b = this.value.replace(/[^\w\s,#\(\)\.]/g, "");
    ...
    a.fn.ace_colorpicker = function (d, e) {
        var f, g = this.each(function () {
            var b = a(this), g = b.data("ace_colorpicker"), h = "object" == typeof d && d;
            g || b.data("ace_colorpicker", g = new c(this, h)), "string" == typeof d && (f = g[d](e))
        });
        return f === b ? g : f
    }, a.fn.ace_colorpicker.defaults = {pull_right: !1, caret: !0, auto_pos: !0}
}(window.jQuery), function (a, b) {
    var c = "multiple" in document.createElement("INPUT"), d = "FileList" in window, e = "FileReader" in window,
        f = "File" in window, g = function (b, c) {
            var d = this, e = ace.helper.getAttrSettings(b, a.fn.ace_file_input.defaults);
            ...
            var f = this.$element.closest("label").css({display: "block"}), g = 0 == f.length ? "label" : "span";
    ...
    g.error = {
        ...
        if (d && 0 != d.length) {
            ...
            for (var g = 0; g < d.length; g++) {
                ...
                } else this.$label.find(".ace-file-name").attr({"data-title": h}).find(ace.vars[".icon"]).attr("class", ace.vars.icon + m)
            }
            return !0
        }
    ...
    var h = function () {
        var a = this, b = this.$element.parent();
        b.off("dragenter").on("dragenter", function (a) {
            ...
            if (b.preventDefault(), b.stopPropagation(), !a.disabled) {
                var c = b.originalEvent.dataTransfer, d = c.files;
        ...
        var c = this, d = c.$label.find(".ace-file-name:last"), e = new a.Deferred, h = function (b, c) {
            ...
            var i = k(b, h);
            if (null == i) return a(this).remove(), void e.reject({code: g.error.THUMBNAIL_FAILED});
            var j = !0;
            if (f && f instanceof File) {
                f.width = i.width, f.height = i.height, c.$element.trigger("file.preview.ace", {file: f});
                var l;
                c.$element.trigger(l = new a.Event("file.preview.ace"), {file: f}), l.isDefaultPrevented() && (j = !1)
            }
            if (j) {
                var m = i.previewWidth, n = i.previewHeight;
                "small" == c.settings.thumbnail ? m = n = parseInt(Math.max(m, n)) : d.addClass("large"), a(b).css({
                    "background-image": "url(" + i.src + ")",
                    width: m,
                    height: n
                }).data("thumb", i.src).attr({src: "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAADUlEQVQImWNgYGBgAAAABQABh6FO1AAAAABJRU5ErkJggg=="}).show()
            }
            e.resolve()
        }, j = function (a) {
            d.find("img").remove(), e.reject({code: g.error.IMAGE_LOAD_FAILED})
        };
        if (f && b instanceof File) {
            ...
            l.onload = function (a) {
                ...
                e.reject({code: g.error.FILE_LOAD_FAILED})
            }, l.readAsDataURL(b)
        ...
        var d = m(this.settings.allowExt), e = m(this.settings.denyExt), g = n(this.settings.allowMime),
            h = n(this.settings.denyMime), i = this.settings.maxSize || !1;
        if (!(d || e || g || h || i)) return !0;
        for (var j = [], k = {}, l = 0; l < b.length; l++) {
            var o = b[l], p = f ? o.name : o;
            if (!d || d.test(p)) if (e && e.test(p)) "ext" in k || (k.ext = []), k.ext.push(p); else {
                var q;
                if (f) {
    ...
    a.fn.aceFileInput = a.fn.ace_file_input = function (c, d) {
        var e, f = this.each(function () {
            var b = a(this), f = b.data("ace_file_input"), h = "object" == typeof c && c;
    ...
    a.fn.bs_typeahead = function (c) {
        return this.each(function () {
            var d = a(this), e = d.data("bs_typeahead"), f = "object" == typeof c && c;
    ...
    a.fn.ace_wysiwyg = function (b, c) {
        var d = a.extend({speech_button: !0, wysiwyg: {}}, b),
            ...
            f = {
                ...
                foreColor: {values: e, title: "Change Color"},
                backColor: {values: e, title: "Change Background Color"},
        ...
        return this.each(function () {
            ...
            d.speech_button && "onwebkitspeechchange" in (k = document.createElement("input")) && (b += ' <input class="wysiwyg-speech-input" type="text" data-edit="inserttext" x-webkit-speech />'), k = null, b += " </div> ", b = d.toolbar_place ? d.toolbar_place.call(this, b) : a(this).before(b).prev(), a.fn.tooltip && b.find("a[title]").tooltip({
                ...
                var b = a(this).ace_colorpicker({pull_right: !0}).change(function () {
                    a(this).nextAll("input").eq(0).val(this.value).change()
                }).next().find(".btn-colorpicker");
                a.fn.tooltip && b.tooltip({title: this.title, animation: !1, container: "body"})
            });
            var l = a(this), m = !1;
            ...
            var n = a.extend({}, {
                activeToolbarClass: "active", toolbarSelector: b
            }, d.wysiwyg || {});
            a(this).wysiwyg(n)
        }), this
    }
    ...
    function c(b, c) {
        var d = ace.helper.getAttrSettings(b, a.fn.ace_spinner.defaults),
            e = a.extend({}, a.fn.ace_spinner.defaults, c, d), f = e.max;
        f = ("" + f).length;
        var g = parseInt(Math.max(20 * f + 40, 90)), h = a(b), i = "btn-sm", j = 2;
    ...
    a.fn.ace_spinner = function (d, e) {
        var f, g = this.each(function () {
            var b = a(this), g = b.data("ace_spinner"), h = "object" == typeof d && d;
    ...
    a.fn.aceTree = a.fn.ace_tree = function (b) {
        ...
        return this.each(function () {
            var d = ace.helper.getAttrSettings(this, c), e = a.extend({}, c, b, d), f = a(this);
    ...
    a.fn.aceWizard = a.fn.ace_wizard = function (b) {
        return this.each(function () {
            ...
            var d = b && b.buttons ? a(b.buttons) : c.siblings(".wizard-actions").eq(0), e = c.data("fu.wizard");
    ...
    function c(b, c) {
        var e = this, f = a(b), g = "right", h = !1, i = f.hasClass("fade"),
        ...
        var l = f.find(".modal-dialog"), m = f.find(".modal-content"), n = 300;
        this.initiate = function () {
            ...
            ace.vars.touch ? m.addClass("overflow-scroll").css("max-height", c + "px") : m.hasClass("ace-scroll") || m.ace_scroll({
                ...
                if (ace.vars.touch) m.css("max-height", (h ? m.height() : l.height()) + "px"); else {
                    ...
                    m.ace_scroll("update", {size: a}).ace_scroll("enable").ace_scroll("reset")
                }
            ...
            var b = a(".main-container"), c = f.find(".modal-dialog");
            if (c.css({right: "", left: ""}), b.hasClass("container")) {
                var e = !1;
                1 == h && (c.css(g, parseInt((d.width() - b.width()) / 2)), e = !0), e && ace.vars.firefox && ace.helper.redraw(b[0])
            }
        }, this.flip = function () {
            var a = {right: "left", left: "right", top: "bottom", bottom: "top"};
    ...
    a(document).on("show.bs.modal", ".modal.aside", function (b) {
        ...
        var f, g = this.each(function () {
            var b = a(this), g = b.data("ace_aside"), h = "object" == typeof d && d;

                                            ...
                                            <tbody>
                                                @foreach ($investors as $investor)
                                                    <tr>
                                                        ...
                                                        <td> {!! \App\Models\Admin\UserDeposit::where('user_id', $investor->id)->get('name') !!}</td>
                                                        <td>
                                                            @if ($investor->payment_image)
                                                                <button class="btn btn-success"
                                                                    style="border: none !important;" id="paymentView"
                                                                    data-id="{{ $investor->id }}"
                                                                    data-name="{{ $investor->name }}"
                                                                    onclick="viewPayment(this)">bkash</button>
                                                            @else
                                                                <button class="btn btn-warning"
                                                                    style="border: none !important;">Wallet</button>
                                                            @endif
                                                            <!-- The Modal -->
                                                                    ...
                                                                    <div class="modal-body">
                                                                        <div class="row">
                                                                            <div class="col-lg-12">
                                                                                <table id="storeList">
                                                                                    <div class="cardmodel">
                                                                                        <img src="{{ asset($investor->payment_image) }}"
                                                                                            alt="Payment-image"
                                                                                            style="width:30%">
                                                                                        <div class="title">
                                                                                            <h2>{{ $investor->name }}</h2>
                                                                                            <p><i class="fa fa-credit-card"
                                                                                                    aria-hidden="true"></i>Transaction
                                                                                                No:
